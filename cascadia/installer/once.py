...
DEFAULT_CONFIG: Dict[str, Any] = {
    ...
    'flint': {
        'pulse_file': './data/runtime/flint.pulse',
    ...
    'components': [
        {'name': 'crew',      'module': 'cascadia.registry.crew',            'port': 5100, 'tier': 1, 'pulse_file': './data/runtime/crew.pulse'},
        {'name': 'vault',     'module': 'cascadia.memory.vault',             'port': 5101, 'tier': 1, 'pulse_file': './data/runtime/vault.pulse'},
        {'name': 'sentinel',  'module': 'cascadia.security.sentinel',        'port': 5102, 'tier': 1, 'pulse_file': './data/runtime/sentinel.pulse'},
        {'name': 'curtain',   'module': 'cascadia.encryption.curtain',       'port': 5103, 'tier': 1, 'pulse_file': './data/runtime/curtain.pulse'},
        {'name': 'beacon',    'module': 'cascadia.orchestrator.beacon',      'port': 6200, 'tier': 2, 'pulse_file': './data/runtime/beacon.pulse', 'depends_on': ['crew']},
        {'name': 'stitch',    'module': 'cascadia.automation.stitch',        'port': 6201, 'tier': 2, 'pulse_file': './data/runtime/stitch.pulse'},
        {'name': 'vanguard',  'module': 'cascadia.gateway.vanguard',         'port': 6202, 'tier': 2, 'pulse_file': './data/runtime/vanguard.pulse'},
        {'name': 'handshake', 'module': 'cascadia.bridge.handshake',         'port': 6203, 'tier': 2, 'pulse_file': './data/runtime/handshake.pulse'},
        {'name': 'bell',      'module': 'cascadia.chat.bell',                'port': 6204, 'tier': 2, 'pulse_file': './data/runtime/bell.pulse'},
        {'name': 'almanac',   'module': 'cascadia.guide.almanac',            'port': 6205, 'tier': 2, 'pulse_file': './data/runtime/almanac.pulse'},
        {'name': 'prism',     'module': 'cascadia.dashboard.prism',          'port': 6300, 'tier': 3, 'pulse_file': './data/runtime/prism.pulse', 'depends_on': ['crew', 'sentinel', 'beacon']},
    ],
