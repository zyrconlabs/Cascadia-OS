...
COMMANDS: dict[str, dict] = {
    ...
    "/about":          {"operator": None,         "description": "Version, node, commit hashes, services, uptime"},
    "/drift":          {"operator": None,         "description": "Compare installed version vs stable release (per-repo)"},
    "/update":         {"operator": None,         "description": "Update Cascadia OS to the pinned stable release (owner only)"},
...
def build_help_text() -> str:
    lines = [
        ...
        "/about        Version, node, commits, services, uptime",
        "/drift        Compare installed version vs stable release (per-repo)",
        "/update       Update Cascadia OS to the pinned stable release (owner)",
